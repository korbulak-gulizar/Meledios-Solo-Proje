...
import { cards } from "./SingleSongData";
import styles from "./SingleSongsList.module.scss";
import { ViewAll } from "../WievAllIcon/WievAllicon";

const SingleSongsList: React.FC = () => {
  return (
    <div className={styles.wrapper}>
      <div className={styles.header}>
        <h1 className={styles.titleWeekly}>
          Single <span>Songs</span>
        </h1>
      </div>
...
export default SingleSongsList;
